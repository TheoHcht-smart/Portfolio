    ...
    <div className="container flex items -center justify-between">
        <a className="text-xl font-bold text-primary flex items-center" href= "#hero">
            <span className="relative z-10 ">
                ...
                <span className="text-glow text-foreground">Huchot Théo</span>{" "} Portfolio
            </span>
        </a>
        ...
        {/*mobile nav*/}
            <div className={cn("fixed inset-0 bg/background/95 backdrop-blour-md z-40 flex flex-col items-center justify-center",
